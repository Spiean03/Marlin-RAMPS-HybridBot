...
#define STRING_CONFIG_H_AUTHOR "(Andreas Spielhofer, CoreXY)" // Who made the changes.
...
//#define USE_ZMIN_PLUG //only define it if endstop is used
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_1_X 63
  #define ABL_PROBE_PT_1_Y 37
  #define ABL_PROBE_PT_2_X 63
  #define ABL_PROBE_PT_2_Y 163
  #define ABL_PROBE_PT_3_X 173
